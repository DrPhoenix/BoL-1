...
function PluginOnDraw()
 ...
 function Menu()
  ...
  AutoCarry.PluginMenu:addSubMenu("-- [Range & Collision Settings] --", "ranges")
  ...
  AutoCarry.PluginMenu.ranges:addParam("ColSwap", "Use - Fast Collision (Reload)", SCRIPT_PARAM_ONOFF, true)
...
function OnAttacked()
		if WAble and (AutoCarry.MainMenu.AutoCarry) and AutoCarry.PluginMenu.useW and AutoCarry.PluginMenu.resetW then ProdictW:GetPredictionCallBack(Target, CastW) end
	end
...
function MysticShot3()
        if QAble and AutoCarry.PluginMenu.qFarm then ProdictQ:GetPredictionCallBack(Minion, CastQ) end
end    
...
function RebornCheck()
	...
	if AutoCarry.PluginMenu.ranges.ColSwap then PrintChat("<font color='#FFFF33'>>> Ezreal's Time to Strike: Fast Collision Loaded!</font>") else PrintChat("<font color='#FFFF33'>>> Ezreal's Time to Strike: Normal Collision Loaded!</font>") end
end

--UPDATEURL=
--HASH=50777065148AD10B816DFE995A92C55E
