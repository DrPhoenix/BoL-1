...
local spellR = {spellKey = _R, range = 1700, speed = math.huge, delay = 1000, width = 200, minions = false }

AutoCarry.PluginMenu:addParam("UseR", "Use Ult", SCRIPT_PARAM_ONOFF, true)                
AutoCarry.PluginMenu:addParam("Max6", "Max Stacks At 6", SCRIPT_PARAM_SLICE, 2, 0, 10, 0)                 
AutoCarry.PluginMenu:addParam("Max12", "Max Stacks At 12", SCRIPT_PARAM_SLICE, 3, 0, 10, 0)                
AutoCarry.PluginMenu:addParam("Max18", "Max Stacks At 18", SCRIPT_PARAM_SLICE, 4, 0, 10, 0)                
...
function PluginOnTick()
	...
	if not AutoCarry.PluginMenu.UseR then return end
...
--UPDATEURL=
--HASH=B84E4173DFFB7A85A3C369743442E47F
